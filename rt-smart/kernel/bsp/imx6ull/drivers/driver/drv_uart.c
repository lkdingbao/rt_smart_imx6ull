...
_internal_rw struct skt_uart _s_uart[eDevUart_Max] = {
#ifdef BSP_USING_UART1
{
    .name = "uart1",
    .periph.paddr = REALVIEW_UART1_BASE,
    .irqno = UART1_IRQn,
    .gpio = {
...
{
    .name = "uart2",
    .periph.paddr = REALVIEW_UART2_BASE,
    .irqno = UART2_IRQn,
    .gpio = {
...
{
    .name = "uart3",
    .periph.paddr = REALVIEW_UART3_BASE,
    .irqno = UART3_IRQn,
    .gpio = {
...
{
    .name = "uart4",
    .periph.paddr = REALVIEW_UART4_BASE,
    .irqno = UART4_IRQn,
    .gpio = {
...
{
    .name = "uart5",
    .periph.paddr = REALVIEW_UART5_BASE,
    .irqno = UART5_IRQn,
    .gpio = {
...
{
    .name = "uart6",
    .periph.paddr = REALVIEW_UART6_BASE,
    .irqno = UART6_IRQn,
    .gpio = {
...
{
    .name = "uart7",
    .periph.paddr = REALVIEW_UART7_BASE,
    .irqno = UART7_IRQn,
    .gpio = {
...
{
    .name = "uart8",
    .periph.paddr = REALVIEW_UART8_BASE,
    .irqno = UART8_IRQn,
    .gpio = {
...
static void _uart_gpio_init( struct skt_uart *device )
{
