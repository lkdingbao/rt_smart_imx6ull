...
struct mem_desc platform_mem_desc[] = {
    ...
    {KERNEL_VADDR_START+0x0f000000, KERNEL_VADDR_START + 0x0fbfffff, KERNEL_VADDR_START+0x0f000000+PV_OFFSET, (SHARED|AP_RW|DOMAIN0|MEMWT|DESC_SEC)}, //12MB for display memory
    {KERNEL_VADDR_START+0x0fc00000, KERNEL_VADDR_START + 0x0fffffff, KERNEL_VADDR_START+0x0fc00000+PV_OFFSET, (SHARED|AP_RW|DOMAIN0|MEMWT|DESC_SEC)}, //4MB  for enet memory
};
#else
struct mem_desc platform_mem_desc[] = {
